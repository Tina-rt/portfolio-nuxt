  ...
  <UPageHero :ui="{
    ...
    <template #headline>
      <Motion :initial="{
        ...
        <NuxtImg :src="global.picture?.light!" :alt="global.picture?.alt!" width="72" height="72" format="webp"
          quality="100"
          class="size-18 ring ring-default ring-offset-3 ring-offset-(--ui-bg) rounded-full object-cover" />
      </Motion>
    </template>
